			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
						<h3>Gunakan form ini untuk permintaan voucher</h3>
						<form action="proses.php" method="POST">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="nope" class="form-control" placeholder="Masukkan Nomor WA Anda">
								</div>
							</div>
							<div class="form-group text-center">
								<input type="submit" value="Claim Sekarang" class="btn btn-info">
							</div>
						</form>		
					</div>
